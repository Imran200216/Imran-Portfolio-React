    ...
    <section id="contact" className="py-16 sm:py-20 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="fade-in-up">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-8 sm:mb-12">Let's Connect</h2>
          
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 max-w-6xl mx-auto">
            <div className="space-y-6 order-2 md:order-1">
              <Card className="bg-card/50 backdrop-blur-sm">
                <CardHeader className="p-4 sm:p-6">
                  <CardTitle className="text-primary text-lg sm:text-xl">Get In Touch</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4 p-4 sm:p-6 pt-0">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-sm sm:text-base">Open to freelance AI/ML projects</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Star className="w-4 h-4 sm:w-5 sm:h-5 text-green-500" />
                      <span className="text-sm sm:text-base">Available for backend development</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Star className="w-4 h-4 sm:w-5 sm:h-5 text-primary" />
                      <span className="text-sm sm:text-base">Seeking internship opportunities</span>
                    </div>
                  </div>
            ...
            <Card className="bg-card/50 backdrop-blur-sm order-1 md:order-2">
              ...
              <CardContent className="space-y-4 p-4 sm:p-6 pt-0">
                ...
                >
                  <Input name="name" placeholder="Your Name" required className="text-sm sm:text-base" />
                  <Input name="email" placeholder="Your Email" type="email" required className="text-sm sm:text-base" />
                  <Input name="subject" placeholder="Subject" required className="text-sm sm:text-base" />
                  <Textarea name="message" placeholder="Your Message" className="min-h-[100px] sm:min-h-[120px] text-sm sm:text-base" required />
                  <Button className="w-full text-sm sm:text-base" type="submit">Send Message</Button>
                </form>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="text-center mt-8 sm:mt-12">
            <p className="text-sm sm:text-base text-muted-foreground">
              © 2024 Mohammed Aashiq | Zarnex.ai
            </p>
          </div>
        </div>
      </div>
